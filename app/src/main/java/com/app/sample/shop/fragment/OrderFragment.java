...
public class OrderFragment extends Fragment {
    ...
    private class Connect extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... urls) {
            ...
            try {
                URL url = new URL("http://hamoha.com/test/getOrders?CID=" + sessionManager.getCurrentCustomerID());
//                URL url = new URL ("http://hamoha.com/Project/getOrders");
                ...
                if (parentArray.length() < 1) {
                    ...
                    for (int i = 0; i < parentArray.length(); i++) {
                        ...
                        double shippingCost = childObject.getDouble("shippingCost");
                        String deliverDate = childObject.getString("deliverDate");
                        double TotalCost = childObject.getDouble("cost");
                        ...
                        for (int v = 0; v < orderProductsArray.length(); v++) {
                            ...
                            for (int j = 0; j < 1; j++) {
                                images_links.add(Product.getString("link"));
                            }
